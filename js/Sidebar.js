...
Sidebar.prototype.addBasicPalette = function (dir) {
  ...
  this.addStencilPalette(
    ...
    dir + "/basic.xml",
    ";verticalLabelPosition=bottom;verticalAlign=top;whiteSpace=wrap;html=1;strokeColor=#ffffff;strokeWidth=2;fillColor=#3333FF;strokeWidth=2",
    null,
    null,
    null,
    null,
...
Sidebar.prototype.createVertexTemplate = function (
  ...
  if (style.includes('shape=rectangle')) {
    cells[0].setConnectable(false);  // Make the rectangle non-connectable
  }
  return this.createVertexTemplateFromCells(
    cells,
    width,
...
Sidebar.prototype.addImagePalette = function (
  ...
  fns.push(
   ...
   //   'shape=rectangle;fillColor=#000000;strokeColor=#FFFFFF;strokeWidth=2;verticalAlign=top;align=center;spacingTop=-5;connectable=0;', // Style string
   'shape=rectangle;fillColor=#FFFFFF;strokeWidth=2;verticalAlign=top;align=center;spacingTop=-5;fontSize=12;fontColor=#000000;fontStyle=1;', // Style string with font styling  
      720,
      360,
      "Trust Boundary",
      "Trust Boundary",
